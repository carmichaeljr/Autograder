...
silent only
silent tabonly
cd ~/Documents/Programming/JavaProgams/Autograder
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +173 AutoGrader.java
badd +1 CodeTestCases.json
badd +1 HWData.json
badd +20 TestAdapter.java
badd +1 Pair.java
badd +1 ../../../School/College/341LeadTAWork/grade.py
badd +1 ReadmeTestCases.json
badd +17 src/AutoGrader.java
badd +1 src/TestAdapter.java
badd +37 src/Pair.java
badd +5 AutoGraderException.java
badd +1 src/AutoGraderException.java
badd +1 src/Print.java
badd +3 jc-args
badd +24 src/SettingsLoader.java
badd +36 src/SubmissionCleaner.java
badd +78 src/SubmissionManager.java
badd +1 Settings.java
badd +33 src/Settings.java
badd +22 src/Gradebook.java
badd +1 src/TestRunner.java
badd +3 src/HWData.java
badd +3 RarsProc
badd +1 src/RarsProc/RarsProc.java
badd +1 src/java
badd +17 src/AutoGrader/AutoGrader.java
badd +1 src/AutoGrader/SubmissionManager.java
badd +1 src/AutoGrader/Settings.java
badd +1 src/AutoGrader/TestRunner.java
badd +1 src/AutoGrader/Gradebook.java
badd +1 src/AutoGrader/HWData.java
badd +1 src/AutoGrader/TestAdapter.java
badd +1 src/AutoGrader/Pair.java
badd +10 ../rars/build-jar.sh
...
exe 'vert 2resize ' . ((&columns * 135 + 135) / 271)
tabnext
edit src/AutoGrader/SubmissionManager.java
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
if bufexists('src/AutoGrader/Settings.java') | buffer src/AutoGrader/Settings.java | else | edit src/AutoGrader/Settings.java | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 135 + 135) / 271)
tabnext
edit src/AutoGrader/TestRunner.java
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
if bufexists('HWData.json') | buffer HWData.json | else | edit HWData.json | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('CodeTestCases.json') | buffer CodeTestCases.json | else | edit CodeTestCases.json | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
